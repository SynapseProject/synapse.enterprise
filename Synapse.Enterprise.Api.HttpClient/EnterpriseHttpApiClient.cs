...
{
    public class EnterpriseHttpApiClient : HttpApiClientBase
    {
        string _rootPath = "/synapse/execute";

        public EnterpriseHttpApiClient(string baseUrl, string messageFormatType = "application/json") : base( baseUrl, messageFormatType )
        {
        }
